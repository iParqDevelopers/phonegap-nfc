...
declare namespace PhoneGapNfc {
    ...
    interface Nfc extends Util {
        ...
        /**
         * Function nfc.addMifareUltralightListener registers the callback for ndef events.
         * A ndef event is fired when a Mifare Ultralight card is read.
         * @param callback The callback that is called when an Mifare Ultralight card is read.
         * @param win The callback that is called when the listener is added.
         * @param fail The callback that is called if there was an error.
         */
        addMifareUltralightListener(callback:(event:NdefTagEvent) => void, win?:() => void, fail?:() => void):void;

        /**
         * Function nfc.addMifareClassicListener registers the callback for ndef events.
         * A ndef event is fired when a Mifare Classic card is read.
         * @param callback The callback that is called when an Mifare Classic card is read.
         * @param win The callback that is called when the listener is added.
         * @param fail The callback that is called if there was an error.
         */
        addMifareClassicListener(callback:(event:NdefTagEvent) => void, win?:() => void, fail?:() => void):void;
